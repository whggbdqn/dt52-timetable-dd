...
<!-- <script src="light7/js/light7.min.js"></script> -->
<script src="bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="tab/js/dingtalk.js"></script>
<script type="text/javascript">
	//在此拿到jsAPI权限验证配置所需要的信息
	var _config =
<%=com.alibaba.dingtalk.openapi.demo.auth.AuthHelper
					.getConfig(request)%>
	;
</script>
<script type="text/javascript" src="javascripts/demo2.js"></script>
<style>
	#tabs{
		font-size: 25px;
		position: relative;
...
/* 		width: 33%; */
	...
	.color{
		color: #0894ec;
		border-bottom: 2px #0894ec solid;
	}
</style>
<body>
